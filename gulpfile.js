...
exports.build   = series(cleandist, scripts, styles, images, html2pug, buildcopy)
exports.default = series(scripts, styles, html2pug, images, parallel(browsersync, startwatch))
